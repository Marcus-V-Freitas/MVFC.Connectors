...
public sealed record ComprovantePagamentoResponse(
    ...
    [property: JsonPropertyName("descricaoTituloComprovante")] TituloComprovante DescricaoTituloComprovante)
{
    ...
    [FlexibleString, JsonPropertyName("numeroCpfCnpjBeneficiario")]
    ...
    [FlexibleString, JsonPropertyName("numeroCpfCnpjBeneficiarioFinal")]
    ...
    [FlexibleString, JsonPropertyName("numeroCpfCnpjPagador")]
